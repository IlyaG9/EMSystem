<%-- 
    ...
    Created on : 10.04.2014, 14:00:07
    Author     : ILYA
--%>
...
<div>
    ...
    <sf:form  method="POST" modelAttribute="employee" id="employee_form" action="${pageContext.servletContext.contextPath}/employee/edit">
        <fieldset>
            <sf:hidden id="employee_id" path="id"/>
